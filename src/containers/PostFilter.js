...
function Header(props) {
    ...
    // Return UI
    return (
        <header id="Header" className="container-fluid row m-0 bg-white border-bottom border-info">
            <nav className="navbar navbar-expand-md">

                { /* Button - Start */ }
                <button className="navbar-toggler text-info" type="button" data-toggle="collapse" data-target="#collapsibleLowerNavbar">
                ...
                <div className="collapse navbar-collapse" id="collapsibleLowerNavbar">
                    ...
                    <ul className="navbar-nav">
                        <li className="nav-item">
                            <a className="nav-link text-info border-right mr-3 pr-3" href="/"> <i className="fa fa-reply" role="img" aria-label="back home"></i> Back Home </a>
                        </li>
                    </ul>
                    { /* Previous Page - Start */ }
                    ...
                    <ul className="navbar-nav">
                        ...
                        <li className="nav-item dropdown mr-3">
                            <a className="nav-link text-info dropdown-toggle" href="#" id="navbardrop" data-toggle="dropdown">
                                Price
                            </a>
                        ...
                        <div className="col-md-4 col-lg-3 p-2" key={i++}>
                            <a href={`/view/${postId}`} >
                                <div className="card shadow-sm border-info">
                                    ...
                                    { /* body */}
                                    <div className="card-body p-0 border-top border-info">

                                        <div className="float-left p-3 w-50">
                                            <p className="m-0 text-info" style={{ textTransform: "uppercase" }}>
                                        ...
                                        <div className="float-right text-right p-3 w-50">
                                            <p className="m-0 text-primary"><b>${price}</b></p>
