...
export default function Home() { 
    ...
    return (
        <main id="Home" className="border-bottom"> 
            ...
            <SectionA posts={dummyPosts} isLoading={isLoading} />
...
function Header(props) {
    ...
    return (
        ...
        <header  id="Header" className="container-fluid mx-auto row m-0" style={{ backgroundImage: `url(${img1})` }} >
            ...
            <div className="col-sm-4 mx-auto align-self-center text-center bg-white rounded p-4 shadow">
                <h1> Introducing Love Your Car Guarantee </h1>
                <p> See cars your budget will love </p>
            </div>
