    ...
    return (
        <main className="Signup container-fluid bg-white py-4 border-top">
            <div className="row align-items-center justify-content-center">
                ...
                { /* Header - Start */}
                <header className="col-md-4 text-center border-bottom border-info mb-3 pb-3">
                    <h1>Massala</h1>
                ...
                { /* Body - Start */}
                <section className="col-md-4 border rounded border-info p-3">
                    ...
                    <footer className="p-2  w-100 border-top">
                        <p>
                            <mdall>By registering, you agree to Massala's <a href="#">Terms of Service</a> and <a href="#">Privacy Notice</a>.</mdall>
                        </p>
                ...
                <section className="col-md-5 mx-auto">
                    ...
                    <section className="p-2 border-top">
                        <p className="border-bottom pb-3">
                            <small>By using this application, you agree to Massala's <a href="#">Terms of Service</a> and <a href="#">Privacy Notice</a>. </small>
                        </p>
